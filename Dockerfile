...
RUN yum install -y which vim-enhanced zip unzip bzip2 wget dos2unix \
    ...
    python python-ldap MySQL-python libxml2-python \
 && curl --silent --output /opt/maven-3.3.9-bin.tar.gz http://ftp.download-by.net/apache/maven/maven-3/3.5.0/binaries/apache-maven-3.5.0-bin.tar.gz \
